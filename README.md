...
| | |
|---|---|
| [`minicheck`](https://github.com/nickharris808/minicheck) ← *you are here* | The engine: an explicit-state model checker with a CLI. Shortest counterexamples, no required dependencies. |
